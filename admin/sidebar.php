        ...
        <?php if($_SESSION['login_type'] == 1): ?>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="./index.php?page=approve_document" class="nav-link nav-approve_document tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Approve Document</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./index.php?page=my_document" class="nav-link nav-my_document tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>My Upload's</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link nav-is-tree nav-edit_subject nav-view_subject">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./index.php?page=new_subject" class="nav-link nav-new_subject tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Add New</p>
                </a>
              </li>
            ...
            <a href="#" class="nav-link nav-is-tree nav-edit_department nav-view_department">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link nav-is-tree nav-edit_year nav-view_year">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./index.php?page=new_year" class="nav-link nav-new_year tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Add New</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./index.php?page=year_list" class="nav-link nav-year_list tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>List</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link nav-is-tree nav-edit_mail nav-view_mail">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="./index.php?page=new_mail" class="nav-link nav-new_mail tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>Add New</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="./index.php?page=mail_list" class="nav-link nav-mail_list tree-item">
                  <i class="fas fa-angle-right nav-icon"></i>
                  <p>List</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            <a href="#" class="nav-link nav-is-tree nav-edit_book nav-view_book">
