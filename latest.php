<body class="body">
    <main class="page projects-page">
        <section class="portfolio-block projects-cards">
            <div class="container">
                <div class="heading">
                    <h2 style="color: var(--bs-indigo);">Latest Update's</h2>
                </div>
                <div class="row"><center>
                <marquee >Collage Reopening on July-18</marquee>
                    <ul class="ul">
                        <li class="li">2nd Years-Internal Marks Update on 28 of May is dued for  sudents</li>
                        <li class="li"></li>
                        <li class="li"></li>
                        <li class="li"></li>
                        <li class="li"></li>
