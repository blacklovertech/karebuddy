        ...
        <section class="portfolio-block projects-cards">
            ...
            ?>
                    <div class="col-md-6 col-lg-4">
                        <div class="card border-0"><a href="subjectwise.php?<?php echo"name=$course[name]&subjectid=$course[subjectid]"?>"><img class="card-img-top scale-on-hover" src="assets/img/<?php echo $course["imgpath"];?>" alt="Card Image">
                            <div class="card-body">
